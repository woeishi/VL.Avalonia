...
[ProcessNode]
public class MaskedTextBox : AvaloniaControls.MaskedTextBox
{
    protected override Type StyleKeyOverride => typeof(AvaloniaControls.MaskedTextBox);
    public MaskedTextBox Output => this;
    ...
    {
        get => base.Watermark;
        set { if (value != null && base.Watermark != value) base.Watermark = value; }
    }

    public new string? Mask
    {
        get => base.Mask;
        set { if (value != null && base.Mask != value) base.Mask = value; }
    }
